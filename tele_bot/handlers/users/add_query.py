...
@dp.message_handler(CommandStart(), IDFilter(('73053093', '73609237')), state=Adding_query.all_states)
...
# End without photos
@dp.message_handler(RegexpCommandsFilter([r'/end']), state=Adding_query.add_photos) #debt: going to use filter Command("something") instead of RegexphotocounterommandsFilter
